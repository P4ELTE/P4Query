...
public class CodeGenV2 extends RecursiveTask<List<String>> {
    ...
    public CodeGenV2(GraphTraversalSource graphTraversalSource, Object currentId,Object endOfInclude) {
    ...
    public List<String> getCode(){
        ...
        CodeGenV2 task = new CodeGenV2(graphTraversalSource, currentId, endOfInclude);
            ...
            for(int i = 0; i < children.size(); ++i){
                ...
                try{                        
                    if(isSubTreeBigEnough(graphTraversalSource, childId, 20)){
                        ForkJoinTask<List<String>> task = new CodeGenV2(graphTraversalSource,childId,endOfInclude).fork();
                        taskList.add(task);                            
                    }else{
