...
public class MarkToDropImpl extends ExternDefinition {

    public MarkToDropImpl(Declaration iface) throws UnableToLinkDeclaration {
        super(iface, "mark_to_drop", null);
    }
