...
public class UpdateChecksum extends ExternDefinition {

    public UpdateChecksum(Declaration iface) throws UnableToLinkDeclaration {
        super(iface, "update_checksum", null);
