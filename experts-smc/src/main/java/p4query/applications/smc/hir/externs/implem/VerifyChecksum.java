...
public class VerifyChecksum extends ExternDefinition {

    public VerifyChecksum(Declaration iface) throws UnableToLinkDeclaration {
        super(iface, "verify_checksum", null);
