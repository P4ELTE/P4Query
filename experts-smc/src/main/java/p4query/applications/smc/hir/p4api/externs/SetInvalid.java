...
public class SetInvalid extends ExternDeclaration {  //TODO Auto-generated constructor stub

    public SetInvalid() {
        super("setInvalid", null);
        local.appendField("hdr", new GenType("::setInvalid/hdr", 1, null));
    }
