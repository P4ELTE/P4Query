...
public class PacketOutEmitImpl extends ExternDefinition {
    public PacketOutEmitImpl(Declaration iface) throws UnableToLinkDeclaration {
        super(iface, "emit", "packet_out");
    }
